        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <section className="mb-12">
            ...
            <p className="text-[#4B2E2B] dark:text-[#AAAAAA] leading-relaxed mb-4">
              When I defended my PhD in Artificial Intelligence at Université Paris-Saclay, I thought I had a clear path ahead.
            ...
            <p className="text-[#4B2E2B] dark:text-[#AAAAAA] leading-relaxed">
              ...
              the lessons I've learned, and how my academic foundation continues to shape my approach to enterprise AI.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-[#4B2E2B] dark:text-[#AAAAAA] leading-relaxed mb-4">
              Despite the differences, my PhD experience continues to be a foundation I build upon:
            </p>
            <ul className="list-none space-y-3 mb-6">
              <li className="flex items-start text-[#4B2E2B] dark:text-[#AAAAAA]">
                <span className="text-[#C08552] mr-3">▸</span>
                <span><strong>Rigorous Problem-Solving:</strong> The ability to break down complex problems,
                  formulate hypotheses, and systematically test solutions applies to every challenge I face.</span>
              </li>
              <li className="flex items-start text-[#4B2E2B] dark:text-[#AAAAAA]">
                <span className="text-[#C08552] mr-3">▸</span>
                <span><strong>Deep Technical Foundation:</strong> Understanding the mathematics behind models
                  helps me make better architecture decisions and troubleshoot issues that others might miss.</span>
              </li>
              <li className="flex items-start text-[#4B2E2B] dark:text-[#AAAAAA]">
                <span className="text-[#C08552] mr-3">▸</span>
              ...
              <li className="flex items-start text-[#4B2E2B] dark:text-[#AAAAAA]">
                <span className="text-[#C08552] mr-3">▸</span>
                <span><strong>Resilience:</strong> Research teaches you to embrace failure as part of the process.
                  In enterprise AI, experiments fail, projects pivot, and resilience is essential.</span>
              </li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-[#4B2E2B] dark:text-[#AAAAAA] leading-relaxed mb-4">
              <strong>4. Find Mentors:</strong> Seek out people who've made similar transitions. Their guidance
              can accelerate your learning and help you avoid common pitfalls.
            </p>
            <p className="text-[#4B2E2B] dark:text-[#AAAAAA] leading-relaxed">
              <strong>5. Stay Connected to Research:</strong> The gap between research and industry is narrowing.
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-[#8C5A3C] dark:text-[#948979] mb-3">
                  ...
                  and enterprise AI strategy. His research on Detection Transformers has been published at ICIP and ACCV,
                  receiving the Best Student Paper Award at ACCV 2024. He bridges the gap between cutting-edge research
                  and practical AI applications in enterprise settings.
                </p>
                <Link
